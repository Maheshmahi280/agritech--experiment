...
def farmer_dashboard(request):
    ...
    # Get analytics data
    analytics = AnalyticsService.get_farmer_dashboard_analytics(request.user)
...
def restaurant_dashboard(request):
    ...
    # Get analytics data
    analytics = AnalyticsService.get_restaurant_dashboard_analytics(request.user)
    
    # Get recommendations
    from .services import RecommendationService
    recommendations = RecommendationService.get_best_produce_for_restaurant(request.user, limit=5)
